...
if(isset($_POST["submit"]))
  ...
  @$ekle="INSERT INTO anketekle(ekleyen_adi, anket_soru, anket_cevap) VALUES ('$name','$konu','$anket')";
...
<head>
    ...
    <title>Anket Ekleme Paneli</title>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<main>
    <div style="display:flex;">
        ...
        <div style="background-color:rgb(223, 223, 223); width:100%; height:1200px;"><br>
            <div class="container">  
                <form id="contact" action="anketekle.php" method="post">
                <center>  <h3>Anket Ekleme Paneli</h3> <br>
                <center>
                  <fieldset>
                    <input placeholder="Ekleyen Kişinin Adı : "  id="ekleyen" name="ekleyen" type="text" tabindex="1" required autofocus>
                  </fieldset>
                  <fieldset>
          <input placeholder="Anket Sorusu :  type="text" id="soru" name="soru" tabindex="2" required>
                  </fieldset><br>
                 <div class="tarih"><form action="/action_page.php">
                  ...
                  <br>
                  <div class="radio">
                      <b><h4>Anket Cevabı Giriniz : </h4> </b>
            <input type="text" name="anket" value="">  <br>  
                  
                   </div> 
    
                  <fieldset>
                    <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">anketi ekle</button>
                  </fieldset>
