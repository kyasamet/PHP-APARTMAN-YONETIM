                  ...
                  <div class="column" style="background-color:rgb(144, 156, 196);">
                    ...
                    <?php  
                        while( $sonuc=mysqli_fetch_assoc($sorgu) ){
                          echo "Ad Soyad:".$sonuc["ekleyen_adi"]."<br>";     
                          echo "Anket Sorusu:".$sonuc["anket_soru"]."<br>";     
                          echo "Anket Cevabı:".$sonuc["anket_cevap"]."<br>";  
                          break;
