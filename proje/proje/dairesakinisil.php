...
$sql = "DELETE FROM dairesakini WHERE id='$no'";
...
<head>
    ...
    <title>Daire Sakini Silme Paneli</title>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <div style="display:flex;">
        ...
        <div style="background-color:rgb(223, 223, 223); width:100%; height:1200px;"><br>
            <div class="container">  
                ...
                <center>  <h3>Daire Sakini Silme Paneli</h3> <br>
                  <center>
                  <fieldset>
                    <input placeholder="Daire Numarası : " name="daireno" id="daireno" type="text" tabindex="1" required autofocus>
                  </fieldset>
                
                
                
                  <fieldset>
                    <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Daire Sakini Sil</button>
                  </fieldset>
