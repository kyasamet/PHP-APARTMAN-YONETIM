    ...
    <main>
        <div style="display:flex;">
            ...
            <div style="background-color:rgb(223, 223, 223); width:100%; height:1000px;">
              <center><h3>-GİDERLER-</h3></center>
              <div class="row">
               <div class="column" style="background-color:rgb(144, 156, 196);">
                 <h2>OCAK 2022 GİDERLERİ</h2>
                 <p>Giderler...</p>
               </div>
               <div class="column" style="background-color:rgb(144, 156, 196);">
                 <h2>ŞUBAT 2022 GİDERLERİ</h2>
                 <p>Giderler...</p>
               </div>
               <div class="column" style="background-color:rgb(144, 156, 196);">
                 <h2>MART 2022 GİDERLERİ</h2>
                 <p>Giderler...</p>
               </div>
               <div class="column" style="background-color:rgb(144, 156, 196);">
                 <h2>NİSAN 2022 GİDERLERİ</h2>
                 <p>Giderler...</p>
               </div>
               <div class="column" style="background-color:rgb(144, 156, 196);">
                 <h2>MAYIS 2022 GİDERLERİ</h2>
                 <p>Giderler...</p>
               </div>
               <div class="column" style="background-color:rgb(144, 156, 196);">
                 <h2>HAZİRAN 2022 GİDERLERİ</h2>
                 <p>Giderler...</p>
               </div>
