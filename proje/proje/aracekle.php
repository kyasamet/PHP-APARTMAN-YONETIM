...
include("baglan.php");
  ...
  {
    $plaka=$_POST["aracplaka"];
    $model=$_POST["aracmodel"];
    $name=$_POST["kullanici_ad"];
    $daireno=$_POST["daireno"];
    $aracnot=$_POST["aracnot"];
   

    @$ekle="INSERT INTO aracekle(arac_plaka,marka_model,kullanici_adi,daire_no,arac_not) values('$plaka','$model','$name','$daireno','$aracnot')";
...
<head>
    ...
    <title>Araç Ekleme Paneli</title>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<main>
    <div style="display:flex;">
        ...
        <div style="background-color:rgb(223, 223, 223); width:100%; height:1000px;"><br>
            <div class="container">  
                <form id="contact" action="aracekle.php" method="POST">
                <center>  <h3>Araç Ekleme Paneli</h3> <br>
                  <center>
                  <fieldset>
                    <input placeholder="Ekleyen Kişinin Adı : " type="text" tabindex="1" name="ekleyenadi" required autofocus>
                  </fieldset>
                  <fieldset>
                    <input placeholder="Araç Plakası : " type="text" tabindex="2" name="aracplaka" required>
                  </fieldset>
                  <fieldset>
                    <input placeholder="Araç Marka ve Modeli : " type="text" tabindex="3" name="aracmodel" required>
                  </fieldset>
                  <fieldset>
                    <input placeholder="Araç Sahibi Adı Soyadı : " type="text" tabindex="4" name="kullanici_ad" required>
                  </fieldset>
                  <fieldset>
                    <input placeholder="Araç Sahibi Daire No : " type="text" tabindex="5" name="daireno" required>
                  </fieldset> <br>
                  <div class="tarih"><form action="/action_page.php">
                    <label for="baslangic"><b>Aracın Eklendiği Tarih:</b></label> 
                    <input type="date" id="baslangic" name="baslangic"> <br>
  
                 </div> <br>
                  <fieldset>
                    <textarea placeholder="Araç hakkındaki notlarınızı buraya yazınız..." tabindex="4" name="aracnot" required></textarea>
                  </fieldset>
                  <fieldset>
                    <button name="kaydet" type="submit" id="contact-submit" name="kaydet" data-submit="...Sending">Araç Bilgisi ekle</button>
                  </fieldset>
