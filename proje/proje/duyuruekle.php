...
if(isset($_POST["kaydet"]))
  ...
  @$ekle="INSERT INTO duyuruekle(kullanici_adi, email, telefon,duyuru) VALUES ('$ad','$email','$telefon','$duyuru')";
    ...
    <div style="display:flex;">
        ...
        <div style="background-color:rgb(223, 223, 223); width:100%; height:1200px;"><br>
            <div class="container">  
                ...
                <center>  <h3>Duyuru Ekleme Paneli</h3> <br>
                  <center>
                  <fieldset>
                    <input placeholder="Adınız : " type="text" id="kullanici" name="kullanici" tabindex="1" required autofocus>
                  </fieldset>
                  <fieldset>
                    <input placeholder="Mail Adresiniz : " type="email" name="mailadres" tabindex="2" required>
                  </fieldset>
                  <fieldset>
                    <input placeholder="Telefon Numaranız : " type="telefon" name="telefon" tabindex="3" required>
                  </fieldset>
                  <br>
                  <br>
                  <fieldset>
                  ...
                  <fieldset>
                    <textarea placeholder="Duyuruyu buraya yazınız..." name="duyuru" tabindex="8" required></textarea>
                  </fieldset>
                  <fieldset>
                    <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Duyuruyu ekle</button>
                  </fieldset>
