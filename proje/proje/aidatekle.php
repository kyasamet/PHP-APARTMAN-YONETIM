...
if(isset($_POST["submit"]))
  ...
  @$ekle="INSERT INTO `aidatekle` (`id`, `daire_no`, `miktar`) VALUES (NULL, '$name', '$konu');";
...
<head>
    ...
    <title>Aidat Ekleme Paneli</title>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<main>
    <div style="display:flex;">
        ...
        <div style="background-color:rgb(223, 223, 223); width:100%; height:1200px;"><br>
            <div class="container">  
                <form id="contact" action="aidatekle.php" method="post">
                <center>  <h3>Aidat Ekleme Paneli</h3> <br>
                <center>
                  
                    <input placeholder="Daire No : "  id="daireno" name="daireno" type="text" tabindex="1" required autofocus>
            ...
            <input placeholder="Miktarı Giriniz : " type="text" id="miktar" name="miktar" value="">  <br>  
            <br>
                  
                   </div> 
    
                  <fieldset>
                    <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Aidat Ekle</button>
                  </fieldset>
