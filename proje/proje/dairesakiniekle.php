...
if(isset($_POST["submit"]))
  ...
  @$ekle="INSERT INTO `dairesakini` (`id`, `kullanici_adi`) VALUES ('$name', '$konu');";
...
<head>
    ...
    <title>Daire Sakini Ekleme Paneli</title>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <div style="display:flex;">
        ...
        <div style="background-color:rgb(223, 223, 223); width:100%; height:1200px;"><br>
            <div class="container">  
                ...
                <center>  <h3>Daire Sakini Ekleme Paneli</h3> <br>
                  <center>
                  <fieldset>
                    <input placeholder="Daire Numarası : " type="text" name="daireno" tabindex="1" required autofocus>
                  </fieldset>
                  <fieldset>
          <input placeholder="Ad Soyad : " type="text" name="adsoyad" tabindex="2" required>
                  </fieldset><br>
                
                
                  <fieldset>
                    <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Daire Sakini Ekle</button>
                  </fieldset>
