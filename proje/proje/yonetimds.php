...
<nav class="head">
    ...
    <div class="panel">NİZAMMETTİN GÜVENÇ</div>
    <ul>
  <!--      <li>
...
<main>
    <div style="display:flex;">
        <div style="background-color: orange; width: 25%; height: 500px; ">
            ...
            <ul>
              <li><img src="shop.png" width="30px"><a href="genelbakis.php">Genel Bakış</a></li>
              <li><img src="idea.png" width="30px"><a href="anasayfa.php">Anasayfa</a></li>
              <li><img src="salary.png" width="30px"><a href="aidatlar.php">Aidatlar</a></li>
              <li><img src="money.png" width="30px"><a href="giderler.php">Giderler</a></li>
              <li><img src="account.png" width="30px"><a href="hesaplar.php">Hesaplar</a></li>
              <li><img src="bank.png" width="30px"><a href="bankalar.php">Bankalar</a></li>
              ...
              <li><img src="manager.png" width="30px"><a href="yonetim.php">Yönetim</a></li>
